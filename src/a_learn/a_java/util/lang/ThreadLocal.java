 ...
 *
 *
 * // todo ThreadLocal1 ThreadLocal2
 *
 * // todo Thread1  --> ThreadLocal1.getMap() == ThreadLocal2.getMap() && but this is different (ThreadLocal1 and ThreadLocal2)
 */
public class ThreadLocal<T> {
    ...
    public T get() {
        ...
        // todo 通过当前线程的 key 获取 Map，存在于 Thread 中
        ThreadLocalMap map = getMap(t);
        if (map != null) {
            // todo 不为空就使用当前的 ThreadLocal 对象作为 key 获取数据
    ...
    static class ThreadLocalMap {
         ...
         */
        // todo Entry 数据，使用 ThreadLocal 作为弱引用 key，当 key == null 的时候，会在下次 get 操作清理
        ...
        private Entry getEntry(ThreadLocal<?> key) {
            ...
            if (e != null && e.get() == key)
                ...
                // todo 否则可能是 key == null 或者 hash 碰撞了
        ...
        private void set(ThreadLocal<?> key, Object value) {
            ...
            Entry[] tab = table;
            int len = tab.length;
            // todo equals key.threadLocalHashCode % len, 但是更高效;
            int i = key.threadLocalHashCode & (len-1);

            // todo 线性探测法处理 hash 冲突， HashMap 是通过拉链法
            for (Entry e = tab[i];
                 e != null;
                ...
                // todo 如果有 key 是 null 的，表明有 key 已经被回收了
                if (k == null) {
